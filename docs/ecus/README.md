...
| C | 모터·조향 출력 + RF Driver/Gear 입력 | [안내](Motor_Steering_Control/README.md) | [명세](Motor_Steering_Control/SPECIFICATION.md) | [아키텍처](Motor_Steering_Control/ARCHITECTURE.md) | [테스트](Motor_Steering_Control/TEST_REPORT.md) |
