...
> **2026-09-17 이후 참고:** 이 문서는 2026-09-15 시점의 검토 기록이며, 당시 E-Stop 관련 검토/결정 내용을 그대로 남겨둔다. E-Stop 기능은 2026-09-17에 데모 프로젝트 특성상 소프트웨어/하드웨어 전부 제거됐다 (`FINAL_IMPLEMENTATION_SPEC.md` DEC-HW-020/DEC-HW-027/DEC-CTRL-006 REMOVED). 아래 내용은 현재 구현 기준이 아니다.
