...
| C | 모터·조향 출력 + Driver/Gear 물리 입력 | [안내](ecus/Motor_Steering_Control/README.md) | [명세](ecus/Motor_Steering_Control/SPECIFICATION.md) | [아키텍처](ecus/Motor_Steering_Control/ARCHITECTURE.md) | [테스트](ecus/Motor_Steering_Control/TEST_REPORT.md) |
...
| 찾는 내용 | 우선 볼 문서 |
|---|---|
| Gear/Driver 물리 입력 | [Drive 기능 명세](ecus/Motor_Steering_Control/SPECIFICATION.md) |
